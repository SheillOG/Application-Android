...
public class Categorie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnApi1 = (Button) findViewById(R.id.afficher_categorie);


        btnApi1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                RequestQueue queue = Volley.newRequestQueue(Categorie.this);

                String url = "http://10.0.10.130:8092/boutique/public/apiallcategorie";
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    for (int i = 0; i < jsonArray.length(); i++){
                                        ...
                                        lesProduits.add("categorie: " + libelle);
                                    }
                                ...
                                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Categorie.this,android.R.layout.simple_list_item_1, lesProduits);
                                ...
                                lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                        ...
                                        Toast.makeText(Categorie.this, tv.getText() + "" + position, Toast.LENGTH_LONG).show();
                                    }
                                });
                            }
